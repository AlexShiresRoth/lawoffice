...
router.get('/contact', (req, res) => res.render('contact', helper.getServicesInfo));
router.get('/bankruptcy', (req, res) => res.render('bankruptcy', helper.getServicesInfo));
router.get('/estateadmin', (req, res) => res.render('estateadmin', helper.getServicesInfo));
